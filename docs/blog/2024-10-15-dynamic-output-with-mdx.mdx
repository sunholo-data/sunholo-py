...
I've moved through Blogpost, Wordpress, Posterous, Jenkins, Hugo and today I'd like to introduce [Docusaurus](https://docusaurus.io/).
...
One of the feeatures of using Multivac is having a prompt CMS via Langfuse, so I can tweak the prompt as I tailor the responses, but as of right now the prompt for the above bot is:
