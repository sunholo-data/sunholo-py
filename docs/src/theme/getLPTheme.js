...
export const brand = {
  50: 'hsl(10, 76%, 85%)',  // Lightest (based on #e6b3a2)
  100: 'hsl(10, 76%, 75%)', // Slightly darker
  200: 'hsl(10, 76%, 65%)', // Mid-point approaching medium
  300: 'hsl(10, 76%, 55%)', // Medium (based on #d47758)
  400: 'hsl(10, 76%, 45%)', // Darker medium
  500: 'hsl(10, 76%, 35%)', // Even darker
  600: 'hsl(10, 76%, 25%)', // Approaching darkest
  700: 'hsl(10, 76%, 20%)', // Dark (based on #c94435)
  800: 'hsl(10, 76%, 15%)', // Darker
  900: 'hsl(10, 76%, 10%)'  // Darkest
};
...
console.log(brand); // Check the entire brand object
console.log(brand[200], brand[500], brand[800]); // Check specific values
          ...
          root: ({ theme, ownerState }) => ({
            ...
            ...(ownerState.variant === 'contained' &&
              ownerState.color === 'primary' && {
                color: 'white',
                '&$root': {  // Increasing specificity
                  backgroundColor: `${brand[200]} !important`,
                },
                backgroundImage: `linear-gradient(to bottom, ${alpha(brand[100], 0.8)}, ${brand[100]})`,
                boxShadow: `inset 0 2px 0 ${alpha(brand[50], 0.2)}, inset 0 -2px 0 ${alpha(brand[300], 0.4)}`,
                ...
                '&:active': {
                  ...
                  boxShadow: `inset 0 2.5px 0 ${alpha(brand[300], 0.4)}`,
                },
              }),
