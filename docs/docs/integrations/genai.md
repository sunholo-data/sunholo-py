...
A lot of support for Google is provided including [vertexai]
...
Latest version currently in preview for Gemini-Flash-2.0

```python
from sunholo.genai.genaiv2 import GoogleAIConfig, GoogleAI
